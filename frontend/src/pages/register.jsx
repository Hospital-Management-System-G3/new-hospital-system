      ...
      <div className="w-full max-w-screen-lg mx-auto bg-white shadow-2xl rounded-xl overflow-hidden lg:flex">
        ...
        <div className="w-full lg:w-1/2 bg-emerald-100 p-12 flex flex-col justify-center items-center">
          <div className="text-center">
            ...
            <p className="text-lg text-emerald-600 mb-6">Join our community and access your medical information</p>
          </div>
          <div className="grid grid-cols-2 gap-4 text-center">
            <div>
              ...
              <p className="text-emerald-700">Create Profile</p>
            </div>
            <div>
              <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10 text-emerald-500 mx-auto mb-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
              </svg>
              <p className="text-emerald-700">Book Appointments</p>
            </div>
            <div>
              <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10 text-emerald-500 mx-auto mb-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div>
              ...
              <p className="text-emerald-700">Connect with Doctors</p>
            </div>
          </div>
        </div>
        {/* Right Side - Form */}
        <div className="w-full lg:w-1/2 p-12 flex flex-col justify-center">
          <h2 className="text-4xl font-bold mb-8 text-center text-emerald-600">Create an Account</h2>
          ...
          <form onSubmit={handleRegister} className="w-full flex flex-col gap-6">
            <div className="relative">
              ...
              />
              <label htmlFor="username" className="absolute left-4 -top-2.5 bg-gray-100 px-1 text-sm font-semibold text-emerald-600">
                Username
              </label>
            </div>
            <div className="relative">
              ...
              />
              <label htmlFor="email" className="absolute left-4 -top-2.5 bg-gray-100 px-1 text-sm font-semibold text-emerald-600">
                Email
              </label>
            </div>
            <div className="relative">
              ...
              />
              <label htmlFor="password" className="absolute left-4 -top-2.5 bg-gray-100 px-1 text-sm font-semibold text-emerald-600">
                Password
              </label>
            </div>
            <button
            ...
            <p className="mt-8 text-sm text-gray-600 text-center">
              ...
              <a href="/log-in" className="text-emerald-500 font-semibold hover:text-emerald-600 transition-all duration-300 ease-in-out">
                Login
              </a>
            </p>
          </form>
